...
export var TASK = [
  // serviceType 自定义属性，用于区分样式
  {
    label: "shortMessageDelegate",
    actionName: "replace-with-shortMessage-task",
    className: "iconfont icon-icon-test message",
    target: {
      type: "bpmn:ServiceTask",
      serviceType: "shortMessageDelegate"
    }
  },
  {
    label: "appPushDelegate",
    actionName: "replace-with-appPush-task",
    className: "iconfont icon-xiaoxi2 pushapp",
    target: {
      type: "bpmn:ServiceTask",
      serviceType: "appPushDelegate"
    }
  },
  {
    label: "tagDelegate",
    actionName: "replace-with-tag-task",
    className: "iconfont icon-biaoqian addtag",
    target: {
      type: "bpmn:ServiceTask",
      serviceType: "tagDelegate"
    }
  },
  {
    label: "unTagDelegate",
    actionName: "replace-with-unTag-task",
    className: "iconfont icon-xinxinicon removetag",
    target: {
      type: "bpmn:ServiceTask",
      serviceType: "unTagDelegate"
    }
  },
  //   {
  //     label: 'Task',
