...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  assign(actions, {
    "create.start-event": createAction(
      "bpmn:StartEvent",
      "event",
      "iconfont icon-kaishi end",
      "开始"
    ),
    "create.end-event": createAction(
      "bpmn:EndEvent",
      "event",
      "iconfont icon-jieshu end",
      "结束"
    ),
    "event-separator": {
      group: "event",
    ...
    "create.exclusive-gateway": createAction(
      ...
      "gateway",
      "bpmn-icon-gateway-xor green",
      "互斥网关"
    ),
    "create.parallel-gateway": createAction(
      "bpmn:ParallelGateway",
      "gateway",
      "bpmn-icon-gateway-parallel green",
      "并行网关"
    ),
    "gateway-separator": {
      group: "gateway",
    ...
    "create.shortMessageDelegate": createAction(
      "bpmn:ServiceTask",
      "activity",
      "iconfont icon-icon-test message",
      "发送短信",
      "shortMessageDelegate",
      {
    ...
    "create.unTagDelegate": createAction(
      "bpmn:ServiceTask",
      "activity",
      "iconfont icon-xinxinicon removetag",
      "移除标签",
      "unTagDelegate",
      {
